<?php include 'header.php'; ?>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10">
                <form name="Register on delivrhyno" method="POST" action="registerUser.php" class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="contact_email" name="contact_email" type="email" placeholder="contact_email"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="post_code" name="post_code" type="text" placeholder="post_code"
                                       class="form-control input-md" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="contact_phone_region" name="contact_phone_region" type="text"
                                       placeholder="contact_phone_region" class="form-control input-md" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="contact_phone" name="contact_phone" type="text" placeholder="contact_phone"
                                       class="form-control input-md" required>
                            </div>
                        </div>
