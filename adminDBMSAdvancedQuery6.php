<?php include 'header.php'; ?>
	...
	<?php if ( isset($_SESSION["admLoggedIn"]) == "admLoggedIn") { ?>
        <div class="row">
            <div class="col-md-12">
                <h2 style="text-align:center;">Search for all restaurants and their associated branches</h2>
                <br>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-10">
                <form name="Search" method="GET" action="DBMSAdvancedQuery6.php" class="form-horizontal">
                    <fieldset>
